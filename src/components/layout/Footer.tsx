  ...
  return (
    <footer className="bg-ink border-t border-white/5 text-sky-tint">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 py-16 grid grid-cols-1 md:grid-cols-4 gap-10">
        ...
        <div className="md:col-span-2 flex flex-col gap-4">
          ...
          <div className="flex gap-3 mt-2">
            ...
            <a href={bookHref} target="_blank" rel="noopener noreferrer" aria-label="WhatsApp"
              className="p-2 rounded-full border border-white/10 hover:border-odyssey-blue hover:text-odyssey-blue transition-colors">
        ...
        <div className="flex flex-col gap-3">
          <h4 className="text-xs font-semibold tracking-widest uppercase text-odyssey-blue">Explore</h4>
          {[
            ...
            <Link key={l.href} href={l.href} className="text-sm hover:text-odyssey-blue transition-colors">
              {l.label}
            </Link>
          ))}
        </div>
        ...
        {/* Contact + Book */}
        <div className="flex flex-col gap-3">
          <h4 className="text-xs font-semibold tracking-widest uppercase text-odyssey-blue">Book Direct</h4>
          <p className="text-sm opacity-80">{siteConfig.address.city}, {siteConfig.address.state}</p>
          <a href={`mailto:${siteConfig.email}`} className="text-sm hover:text-odyssey-blue transition-colors">
            {siteConfig.email}
          </a>
          <Link href="/property/project-odyssey-ahmedabad/"
      ...
      <div className="border-t border-white/5 px-4 sm:px-6 py-5 max-w-7xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-2 text-xs opacity-50">
        ...
        <span>Made with care in Ahmedabad, India.</span>
      </div>
    </footer>
  );
}
